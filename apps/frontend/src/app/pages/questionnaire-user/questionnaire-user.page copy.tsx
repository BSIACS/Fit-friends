...
import { registerUserThunk } from '../../store/slices/authorization.thunk';


type QuestionnaireUserPageProps = {
  formData: FormData
}
...
export function QuestionnaireUserPage({ formData }: QuestionnaireUserPageProps): JSX.Element {
  ...
  const registerButtonClickHandler = (evt: React.FormEvent<HTMLFormElement>) => {
    evt.preventDefault();
    const questionnaireFormData = new FormData(evt.currentTarget);

    const specialization = questionnaireFormData.getAll('specialization');
    formData.delete('specialization');
    for (let i = 0; i < specialization.length; i++) {
      formData.append('specialization', specialization[i]);
    }
    formData.set('trainingDuration', questionnaireFormData.get('time') as string);
    formData.set('level', questionnaireFormData.get('level') as string);
    formData.set('calories', questionnaireFormData.get('calories-lose') as string);
    formData.set('caloriesPerDay', questionnaireFormData.get('calories-waste') as string);
          ...
          <div className="popup-form__wrapper">
            <div className="popup-form__content">
              <div className="popup-form__form">
                <form method="get" onSubmit={ registerButtonClickHandler }>
                  <div className="questionnaire-user">
                    <h1 className="visually-hidden">Опросник</h1>
                    <div className="questionnaire-user__wrapper">
                      <div className="questionnaire-user__block"><span className="questionnaire-user__legend">Ваша специализация
                        (тип) тренировок</span>
                      ...
                      <div className="questionnaire-user__block">
                        ...
                        <div className="custom-toggle-radio custom-toggle-radio--big questionnaire-user__radio">
                          <div className="custom-toggle-radio__block" >
                            <label>
                              <input type="radio" name="time" value={'10-30'} checked={state.trainingDuration === '10-30' ?? true} onClick={timeRadioButtonClickHandler} />
                          ...
                          <div className="custom-toggle-radio__block">
                            <label>
                              <input type="radio" name="time" value={'30-50'} checked={state.trainingDuration === '30-50' ?? true} onClick={timeRadioButtonClickHandler} />
                              <span className="custom-toggle-radio__icon"></span>
                          ...
                          <div className="custom-toggle-radio__block" >
                            <label>
                              <input type="radio" name="time" value={'50-80'} checked={state.trainingDuration === '50-80' ?? true} onClick={timeRadioButtonClickHandler} />
                              <span className="custom-toggle-radio__icon"></span>
                          ...
                          <div className="custom-toggle-radio__block" >
                            <label>
                              <input type="radio" name="time" value={'80-100'} checked={state.trainingDuration === '80-100' ?? true} onClick={timeRadioButtonClickHandler} />
                              <span className="custom-toggle-radio__icon"></span>
                      ...
                      <div className="questionnaire-user__block">
                          ...
                          <div className="custom-input custom-input--with-text-right questionnaire-user__input">
                            <label>
                              <span className="custom-input__wrapper">
                                <input type="number" name="calories-lose" value={state.calories} onChange={caloriesFieldChangeHandler} />
                        ...
                        <div className="questionnaire-user__calories-waste"><span className="questionnaire-user__legend">Сколько
                          ...
                          <div className="custom-input custom-input--with-text-right questionnaire-user__input">
                            <label>
                              <span className="custom-input__wrapper">
                                <input type="number" name="calories-waste" value={state.caloriesPerDay} onChange={caloriesPerDayFieldChangeHandler} />
                                <span className="custom-input__text">ккал</span>
                              </span>
                            </label>
                          </div>
