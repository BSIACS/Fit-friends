...
import { DecrementUserBalanceRequest } from '../../types/decrement-user-balance-request.interface';
  ...
  return (
    <>
      <div style={{ width: '100%', height: '100%', position: 'fixed', backgroundColor: 'black', zIndex: '100', opacity: .5 }}
        hidden={isReviewsLoaded && isTrainingDataLoaded && isUserBalanceLoaded}></div>
                ...
                <div className="training-card">
                  ...
                  <div className="training-video">
                    ...
                    <div className="training-video__video">
                      {isTrainingDataLoaded && <video controls={isTrainingStarted}>
