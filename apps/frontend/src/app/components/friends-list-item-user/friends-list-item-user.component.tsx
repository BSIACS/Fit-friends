...
type FriendsListItemUserProps = {
  ...
  handleRejectButtonClick: (id: UUID) => Promise<PersonalTrainingInvitationDTO | undefined>,
  handleAcceptButtonClick: (id: UUID) => Promise<PersonalTrainingInvitationDTO | undefined>,
  handleCreateButtonClick: (id: UUID) => Promise<PersonalTrainingInvitationDTO | undefined>,
}
